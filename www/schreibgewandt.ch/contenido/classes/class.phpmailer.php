 ...
 *
 *   $Id: class.phpmailer.php 413 2008-06-30 11:55:36Z frederic.schneider $:
 * }}
 * 
 */
...
class PHPMailer
{
    ...
    */
    ...
    function Send() {
        ...
        {
            $this->SetError(i18n("Provide address"));
            return false;
        }
        ...
        switch($this->Mailer)
        {
            ...
            case "smtp":
                ...
                break;
            default:
            $this->SetError($this->Mailer . i18n("Mailer not supported"));
                $result = false;
                break;
        }
    ...
    function SendmailSend($header, $body) {
        ...
        {
            $this->SetError(i18n("Execute") . $this->Sendmail);
            return false;
        }
    ...
    function MailSend($header, $body) {
        ...
        if(!$rt)
        {
            $this->SetError(i18n("Instantiate"));
            return false;
        }
    ...
    function SmtpSend($header, $body) {
        ...
        {
            $error = i18n("From failed") . $smtp_from;
            $this->SetError($error);
            $this->smtp->Reset();
            return false;
        }
        ...
        if(count($bad_rcpt) > 0) // Create error message
        {
            ...
            $error = i18n("Recipients failed") . $error;
            $this->SetError($error);
            $this->smtp->Reset();
            return false;
        }
        ...
        {
            $this->SetError(i18n("Data not accepted"));
            $this->smtp->Reset();
            return false;
        }
    ...
    function SmtpConnect() {
            ...
            if($this->smtp->Connect($host, $port, $this->Timeout))
            {
                ...
                if($this->SMTPAuth)
                {
                    if(!$this->smtp->Authenticate($this->Username, 
                                                  $this->Password))
                    {
                        $this->SetError(i18n("Authenticate"));
                        $this->smtp->Reset();
                        $connection = false;
                    }
                }
        ...
        if(!$connection)
            $this->SetError(i18n("Connect host"));
    ...
    function AddAttachment($path, $name = "", $encoding = "base64", 
        ...
        if(!@is_file($path))
        {
            $this->SetError(i18n("File access") . $path);
            return false;
        }
    ...
    function EncodeString ($str, $encoding = "base64") {
        ...
        switch(strtolower($encoding)) {
          ...
          case "quoted-printable":
              ...
              break;
          default:
              $this->SetError(i18n("Encoding") . $encoding);
              break;
        }
        return $encoded;
    }
