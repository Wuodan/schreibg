 ...
 *
 *   $Id: front_content.php 959 2009-01-13 22:09:35Z xmurrix $:
 * }}
 *
 */

require_once(realpath('../library/Wdrei/Contenido/Init.php'));
Wdrei_Init :: getInstance('client1')->start();
